...
namespace CodeDeobfuscator
{
	...
	{
        private class InstructionIdentifier
        {
            public InstructionIdentifier(MethodBody body, Instruction instr)
            {
                this.body = body;
                this.instr = instr;
            }
        ...
        private class FieldRemoveInfo
        {
            public List<InstructionIdentifier> references = new List<InstructionIdentifier>();
